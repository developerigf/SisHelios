...
#Region "Reportes  Contables"
    ...
    Public Class SG_CO_Reportes_Registros
        ...
        Public Function get_IB_Cta_20_21(ayo_ As Integer) As DataTable
            Dim cnigf As New SqlConnection("server=servidor;user=sa;pwd=igf348;Initial catalog=DBCLINICA;Pooling=true; Min Pool Size=5; Max Pool Size=10; Pooling = True")
            cnigf.Open()
        ...
        Public Sub get_PLE_Mayor(ayo_ As Integer, mes_ As Integer, empresa_ As Integer, Str_vRutaPdt_ As String)
            ...
            Dim dt_data As DataTable = SqlHelper.ExecuteDataset(Cn, "SG_CO_SP_S_PLE_MAYOR", ayo_, mes_, empresa_).Tables(0)
            ...
            For i As Integer = 0 To dt_data.Rows.Count - 1
                ...
                Strdatos = Strdatos & dt_data.Rows(i)("AC_GLOSA_VOU") & "|"
        ...
        Public Sub get_PLE_Diario(ayo_ As Integer, mes_ As Integer, empresa_ As Integer, Str_vRutaPdt_ As String)
            ...
            Dim dt_data As DataTable = SqlHelper.ExecuteDataset(Cn, "SG_CO_SP_S_PLE_DIARIO", ayo_, mes_, empresa_).Tables(0)
            Dim StrNomArchivo As String
            Dim Strdatos As String
        ...
        Public Sub get_PLE_RegVentas(ayo_ As Integer, mes_ As Integer, empresa_ As Integer, Str_vRutaPdt_ As String)
            ...
            Dim dt_data As DataTable = SqlHelper.ExecuteDataset(Cn, "SG_CO_SP_S_PLE_REGVEN", ayo_, mes_, empresa_).Tables(0)
            Dim StrNomArchivo As String
            Dim Strdatos As String
        ...
        Public Sub get_PLE_RegCompras(ayo_ As Integer, mes_ As Integer, empresa_ As Integer, Str_vRutaPdt_ As String)
            ...
            Dim dt_data As DataTable = SqlHelper.ExecuteDataset(Cn, "SG_CO_SP_S_PLE_REGCOM", ayo_, mes_, empresa_).Tables(0)
            Dim StrNomArchivo As String
            Dim Strdatos As String
            ...
            For i As Integer = 0 To dt_data.Rows.Count - 1
                ...
                Strdatos = Strdatos & Left(dt_data.Rows(i)("CORRELATIVO"), 40) & "|"
                ...
                Strdatos = Strdatos & Left(dt_data.Rows(i)("NUM_DOC"), 20) & "|"
        ...
        Public Sub setImportes_Balance_Gral(ByVal clase As Integer, ByVal grupo As Integer, ByVal cuenta As String, ByVal ayo As Integer, ByVal mes As Integer, ByVal empresa As Integer, ByVal es_mensual As Boolean)
            SqlHelper.ExecuteNonQuery(Cn, "SG_CO_SP_S_BG_1", clase, grupo, cuenta, ayo, mes, empresa, IIf(es_mensual, 1, 0))
        End Sub
        ...
        Public Sub setActualizar_Cta10_SobreGiro(ByVal cuenta As String, ByVal periodo As Integer, ByVal mes As Integer, ByVal empresa As Integer, ByVal acumulado As Integer)
            SqlHelper.ExecuteNonQuery(Cn, "SG_CO_SP_U_BAL_GRAL_1", cuenta, periodo, mes, empresa, acumulado)
        End Sub
        Public Sub set_Actualizar_Resultado_Ejercicio(ByVal ayo As Integer, ByVal mes As Integer, ByVal empresa As Integer, ByVal cuenta_resultado As String)
            SqlHelper.ExecuteNonQuery(Cn, "SG_CO_SP_S_RESUL_BAL_COMPRO_CTA89", ayo, mes, empresa, "000000", "9999999", cuenta_resultado)
        End Sub
...
Siguiente:
        ...
        Public Sub Migrar_Asiento_Ventas_Sisa_Botica(ByVal ayo_ As Integer, ByVal Mes_ As String, ByVal cta12 As String, ByVal cta12Rel As String, ByVal cta40 As String)
            ...
            Dim cnigf As New SqlConnection("server=servidor;user=desarrollo;pwd=cbazan;Initial catalog=DBCLINICA;Pooling=true; Min Pool Size=5; Max Pool Size=10; Pooling = True")
...
#End Region
    ...
    Public Class SG_CO_TB_USUARIO
        ...
        Public Sub Insert(ByRef Entidad As BE.ContabilidadBE.SG_CO_TB_USUARIO)
            Try
                With Entidad
                    ...
                    .US_ID = SqlHelper.ExecuteScalar(Cn, "SG_CO_SP_I_USUARIO", .US_NOMBRE, EncryptString(.US_CLAVE), .US_DESCRIPCION, .US_ISTATUS, .US_USUARIO, .US_TERMINAL, .US_FECREG, Int_IdTipoUsuario, .US_FOTO, .US_TIPO_ACCESO, .US_IDPERSONAL)
        ...
        Public Sub Update(ByVal Entidad As BE.ContabilidadBE.SG_CO_TB_USUARIO)
            Try
                With Entidad
                    SqlHelper.ExecuteNonQuery(Cn, "SG_CO_SP_U_USUARIO", .US_ID, .US_NOMBRE, EncryptString(.US_CLAVE), .US_DESCRIPCION, .US_ISTATUS, .US_USUARIO, .US_TERMINAL, .US_FECREG, .US_IDTIPO_USU.TU_CODIGO, .US_FOTO, .US_TIPO_ACCESO, .US_IDPERSONAL)
                End With
            Catch ex As Exception
                Throw ex
            End Try
    ...
    Public Class SG_CO_TB_ANEXO
        ...
        Public Sub Insert_x_Admision(ByVal Entidad As BE.ContabilidadBE.SG_CO_TB_ANEXO)
...
#End Region
    ...
    Public Class SG_CO_TB_ASIENTO_CONTABLE
        ...
        Public Sub Delete(ByVal Ent_Cab As BE.ContabilidadBE.SG_CO_TB_ASIENTO_CAB)
            Try
                SqlHelper.ExecuteNonQuery(Cn, "SG_CO_SP_D_ASIENTO_CAB", Ent_Cab.AC_ID)
            Catch ex As Exception
                Throw ex
            End Try
        End Sub

        Public Sub Anular_Ventas(ByVal IdVoucher As Integer)
            Try
                SqlHelper.ExecuteNonQuery(Cn, "SG_CO_SP_ANULA_VOUCHER_VENTAS", IdVoucher)
            Catch ex As Exception
                Throw ex
            End Try
        End Sub

        Public Sub Anular_CajaBancos(ByVal IdVoucher As Integer)
            SqlHelper.ExecuteNonQuery(Cn, "SG_CO_SP_ANULA_VOUCHER_CAJA", IdVoucher)
        End Sub
        ...
        Public Sub Insert_Caja_Facturacion(ByRef Ent_Cab As BE.ContabilidadBE.SG_CO_TB_ASIENTO_CAB, _
                                    ByVal Ent_Detalles As List(Of BE.ContabilidadBE.SG_CO_TB_ASIENTO_DET), _
                                    ByRef Str_NumVoucher As String, ls_ids_comprobs As List(Of Integer))
