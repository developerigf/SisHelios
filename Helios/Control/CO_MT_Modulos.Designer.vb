...
Partial Class CO_MT_Modulos
    ...
    Private Sub InitializeComponent()
        ...
        Dim UltraDataColumn9 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("MO_ID")
        Dim UltraDataColumn10 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("MO_DESCRIPCION")
        ...
        Me.uds_Modulos.Band.Columns.AddRange(New Object() {UltraDataColumn9, UltraDataColumn10})
        '
