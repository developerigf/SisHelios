...
Module ModBasConta
    ...
    Public Sub mBuscar_Documento(ByVal td As String, ByVal sd As String, ByVal nd As String, ByVal empresa As Integer, ByVal anexo As Integer, ByVal cuenta As String, ByVal ayo As Integer)
