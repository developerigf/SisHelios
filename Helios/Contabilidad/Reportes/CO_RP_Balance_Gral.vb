    ...
    Private Sub Tool_imprimir_Click(sender As System.Object, e As System.EventArgs) Handles Tool_imprimir.Click
        ...
        Try
            ...
            For j As Integer = 0 To Dt_ctas_sobregiro.Rows.Count - 1
                Obj_ReporteBL.setActualizar_Cta10_SobreGiro(Dt_ctas_sobregiro.Rows(j)("PC_NUM_CUENTA"), txt_Ayo.Text.Trim, uce_Mes.Value, gInt_IdEmpresa, IIf(uos_Formato.Value = 1, 0, 1))
                pb1.Increment(1)
            Next
