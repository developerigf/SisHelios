Public Class FacturacionBE
    ...
    Public Class SG_FA_TB_ARTICULO
        ...
        Public Sub New(AR_CODIGO_ As String, AR_CODIGO_ALT_ As String, AR_DESCRIPCION_ As String, AR_PRECIO_VENTA_ As Double, AR_IDFAMILIA_ As String, AR_IDCATEGORIA_ As String, AR_NUM_CTA_CONTA_ As String, AR_ESTADO_ As String, AR_IDEMPRESA_ As Integer, AR_USUARIO_ As String, AR_TERMINAL_ As String, AR_FECREG_ As String, AR_TIPO_ARTI_ As String, AR_INCLUYE_IGV_ As Integer, AR_ING_RAP_ As Integer, _
                       AR_MON_VTA_ As String, AR_IDPROVEEDOR_ As Integer, AR_IDGRUPO_ As Integer, AR_IDUBICACION_ As Integer, AR_IDPAIS_ As Integer, AR_IDFABRICANTE_ As Integer, AR_MODELO_ As String, AR_MARCA_ As Integer, AR_UM_COMPRA_ As String, AR_UM_VENTA_ As String, AR_UM_DISTRI_ As String, AR_CANT_UMC_ As Double, AR_COLOR_ As String, AR_PESO_ As Double, AR_UM_PESO_ As String, AR_STOCK_MIN_ As Double, AR_CTRL_STOCK_ As Integer, AR_ORIGEN_ As String)
    ...
    Public Class SG_FA_TB_CLIENTE
        ...
        Public Sub New(CL_ID_ As Integer, CL_NOMBRE_ As String, CL_TDOC_ As BE.ContabilidadBE.SG_CO_TB_TIPO_DOC_IDENTIDAD, CL_NDOC_ As String, CL_DIRECCION_ As String, CL_ES_RELACIONADO_ As Integer, CL_USUARIO_ As String, CL_TERMINAL_ As String, CL_FECREG_ As String, CL_IDEMPRESA_ As BE.ContabilidadBE.SG_CO_TB_EMPRESA, CL_ESTADO_ As Integer, CL_FICHA_TEC_ As String, CL_UBIGEO_ As String, CL_IDANEX_CONTA_ As Integer)
    ...
    Public Class SG_FA_TB_COMPROBANTE_D
        ...
        Public Sub New(CD_IDCAB_ As BE.FacturacionBE.SG_FA_TB_COMPROBANTE_C, CD_ITEM_ As Integer, CD_IDARTICULO_ As BE.FacturacionBE.SG_FA_TB_ARTICULO, CD_CANT_ As Double, CD_PRECIO_ As Double, CD_DSCTO_ As Double, CD_SUBTOTAL_ As Double, CD_INAFECTO_ As Integer, CD_IDEMPRESA_ As BE.ContabilidadBE.SG_CO_TB_EMPRESA, CD_IGV_ As Double, CD_TOTAL_ As Double, CD_INC_IGV_ As Integer)
    ...
    Public Class SG_FA_TB_COMPROBANTE_C
        ...
        Public Sub New(CO_ID_ As Integer, CO_TDOC_ As BE.FacturacionBE.SG_FA_TB_DOCUMENTO, CO_SDOC_ As String, CO_NDOC_ As String, CO_FEC_EMI_ As String, CO_FEC_VEN_ As String, CO_SUBTOTAL_ As Double, CO_SUBTOTAL_NA_ As Double, CO_IGV_ As Double, CO_TOTAL_ As Double, CO_IDMONEDA_ As BE.FacturacionBE.SG_FA_TB_MONEDA, CO_TCAM_ As Double, CO_TDOC_REF_ As BE.FacturacionBE.SG_FA_TB_DOCUMENTO, CO_SDOC_REF_ As String, CO_NDOC_REF_ As String, CO_FEC_EMI_REF_ As String, CO_FEC_VEN_REF_ As String, CO_IDEMPRESA_ As BE.ContabilidadBE.SG_CO_TB_EMPRESA, CO_USUARIO_ As String, CO_TERMINAL_ As String, CO_FECREG_ As String, CO_IDCLIENTE_ As BE.FacturacionBE.SG_FA_TB_CLIENTE, CO_NOTAS_ As String, CO_ESTADO_ As Integer, CO_IDPTOVTA_ As BE.FacturacionBE.SG_FA_TB_PUNTO_VENTA, CO_IDFORMA_PAGO_ As BE.FacturacionBE.SG_FA_TB_FORMA_PAGO, CO_ES_CONTA_PROVI_ As Integer, CO_ES_CONTA_CANCE_ As Integer, CO_TASA_IGV_ As Double, CO_IDVOUCHER_ As Integer, CO_NUMVOUCHER_ As String, CO_IDUSUARIO_ As BE.ContabilidadBE.SG_CO_TB_USUARIO, CO_IDDOCU_PAGO_ As BE.FacturacionBE.SG_FA_TB_DOCU_PAGO, CO_REF_PAGO_ As String, CO_ES_REEMPLA_ As Integer, CO_DNI_ As String)
            _CO_DNI = CO_DNI_
